...
import static nataliamirzam.web.RestaurantTestData.*;
import static nataliamirzam.web.user.UserTestData.admin;
import static nataliamirzam.web.user.UserTestData.user;
