...
import nataliamirzam.web.AbstractControllerTest;
...
import static nataliamirzam.web.user.AdminUserController.REST_URL;
import static nataliamirzam.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
import static nataliamirzam.web.user.UserTestData.*;
...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void createInvalid() throws Exception {
        User invalid = new User(null, null, "", "newPass", Set.of(Role.USER, Role.ADMIN));
    ...
    void createDuplicate() throws Exception {
        User expected = new User(null, "New", USER_MAIL, "newPass", Set.of(Role.USER, Role.ADMIN));
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
